...
public class Game {
    ...
    void init() throws InterruptedException {
        System.out.println("Запуск игры Поле Чудес - подготовка к игре. " +
            ...
            // Вопрос/ответ вынес в отдельный метод.
        questions();
...
//        String answer4 = dataEntry.next();
            ...
            // Записываем в массив вопрос/ответ.
        questionsAndAnswers = new String[][]{{question1}, {answer1}};
        //questionsAnswers = new String[][]{{question1, question2, question3, question4},
